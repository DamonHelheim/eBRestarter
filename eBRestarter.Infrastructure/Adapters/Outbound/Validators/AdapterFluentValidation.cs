...
namespace eBRestarter.Infrastructure.Adapters.Outbound.Validators;
...
/// </para>
/// </summary>
public sealed class AdapterFluentValidation<T>(IValidator<T> validator) : IInboundPortApplicationValidator<T>
{
