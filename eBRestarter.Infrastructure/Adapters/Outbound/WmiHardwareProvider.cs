...
namespace eBRestarter.Infrastructure.Adapters
{
    ...
    /// - <strong>Implementierte Ports:</strong> <see cref="IHardwareInfoProviderOutboundPort"/> und <see cref="IOsEditionProviderOutboundPort"/> (aus dem Application Core).<br/>
    ...
    /// </para>
    /// </summary>
    public sealed class WmiHardwareProvider(ILogger<WmiHardwareProvider> logger) : IHardwareInfoProviderOutboundPort, IOsEditionProviderOutboundPort
    {
        private readonly ILogger<WmiHardwareProvider> _logger = logger;
