...
/// </para>
/// </summary>
public abstract class AdapterChromiumBrowserBase(IOutboundPortOsProcessControl processControlPort, IOutboundPortSystemConfigurationRepository settingsPort, IOutboundPortFileSystem fileSystemPort, ILogger logger) : AdapterBrowserBase(processControlPort, settingsPort, fileSystemPort, logger)
{
