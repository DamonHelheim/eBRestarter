...
/// - <strong>Implementierter Port:</strong> <see cref="IFileDeletionOutboundPort"/> (aus dem Application Core).<br/>
...
/// </para>
/// </summary>
public sealed class WindowsFileDeletionServiceAdapter(ILogger<WindowsFileDeletionServiceAdapter> logger) : IFileDeletionOutboundPort
{
    private readonly ILogger<WindowsFileDeletionServiceAdapter> _logger = logger;
