...
/// - <strong>Implementierte Ports:</strong> <see cref="IBrowserExtensionDeploymentOutboundPort"/> und <see cref="IBrowserExtensionPathProviderOutboundPort"/> (aus dem Application Core).<br/>
