...
/// - <strong>Implementierte Ports:</strong> <see cref="IAutoStartRepositoryOutboundPort"/> und <see cref="IBrowserConfigRepositoryOutboundPort"/> (aus dem Application Core).<br/>
