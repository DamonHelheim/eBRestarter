...
/// - <strong>Implementierter Port:</strong> <see cref="ISystemInfoProviderOutboundPort"/> (aus dem Application Core).<br/>
...
public sealed class WindowsSystemInfoProvider(ILogger<WindowsSystemInfoProvider> logger, ISettingsRepositoryOutboundPort registry) : ISystemInfoProviderOutboundPort
{
