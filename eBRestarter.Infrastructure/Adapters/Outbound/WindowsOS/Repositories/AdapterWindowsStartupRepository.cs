...
/// </para>
/// </summary>
public sealed class AdapterWindowsStartupRepository(
    ILogger<AdapterWindowsStartupRepository> logger,
    IOutboundPortSystemConfigurationRepository registry,
    IOutboundPortProcessInfoProvider processInfo) : IOutboundPortAutoStartRepository, IOutboundPortBrowserConfigRepository
{
    ...
    private readonly ILogger<AdapterWindowsStartupRepository> _logger = logger;
    private readonly IOutboundPortSystemConfigurationRepository _registry = registry;
    private readonly IOutboundPortProcessInfoProvider _processInfo = processInfo;
