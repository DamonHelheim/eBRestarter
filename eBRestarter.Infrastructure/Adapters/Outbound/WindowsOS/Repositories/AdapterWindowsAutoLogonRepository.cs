...
public sealed partial class AdapterWindowsAutoLogonRepository(ILogger<AdapterWindowsAutoLogonRepository> logger) : IOutboundPortOsAutoLogonRepository
{
    ...
    private readonly ILogger<AdapterWindowsAutoLogonRepository> _logger = logger;
