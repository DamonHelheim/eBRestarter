...
/// - <strong>Implementierter Port:</strong> <see cref="IAppVersionInfoProviderOutboundPort"/> (aus dem Application Core).<br/>
...
/// </para>
/// </summary>
public sealed class WindowsAppVersionInfoProvider : IAppVersionInfoProviderOutboundPort
{
