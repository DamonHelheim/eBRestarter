...
public class RestSharpClientHandler(ILogger<RestSharpClientHandler> logger, HttpMessageHandler? httpMessageHandler = null) : IRestClientUseCase
{
    private readonly ILogger<RestSharpClientHandler> _logger = logger;
