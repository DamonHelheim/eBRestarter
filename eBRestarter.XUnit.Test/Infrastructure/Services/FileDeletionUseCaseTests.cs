...
{
    /// <summary>
    /// Testet den FileDeletionHandler.
    ...
    /// </summary>
    public class FileDeletionUseCaseTests : IDisposable
    {
        private readonly FileDeletionHandler _sut;
        private readonly string _baseTestDir;

        public FileDeletionUseCaseTests()
        {
            _sut = new FileDeletionHandler();
        ...
        public async Task DeleteFilesAsync_ShouldCleanUpEverything_ExceptExclusions()
        {
            ...
            // Check Progress
            statusUpdates.ShouldContain("AbschlieÃŸende Bereinigung...");
