...
{
    /// <summary>
    /// Testet den WindowsAppPathProviderAdapter.
    ...
    /// </summary>
    public class WindowsAppPathProviderAdapterTests
    {
        private readonly WindowsAppPathProviderAdapter _sut;

        public WindowsAppPathProviderAdapterTests()
        {
            _sut = new WindowsAppPathProviderAdapter();
        }
