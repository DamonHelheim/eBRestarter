...
{
    /// <summary>
    /// Testet den WindowsPathHandler.
    /// Hier prÃ¼fen wir, ob die Klasse die Basis-Pfade (aus dem IPathProvider)
    /// korrekt mit den App-spezifischen Ordnern und Dateinamen kombiniert.
    /// </summary>
    public class WindowsPathUseCaseTests
    {
        private readonly Mock<IPathProvider> _mockPathProvider;
        private readonly WindowsPathHandler _sut;

        public WindowsPathUseCaseTests()
        {
            ...
            _sut = new WindowsPathHandler(_mockPathProvider.Object);
        }
        ...
        ///
        /// WAS WIRD GETESTET?
        /// Wir geben der Klasse einen Fake-Basis-Pfad und prÃ¼fen, ob "Skylar" und "eBRestarter"
        /// fehlerfrei angehÃ¤ngt werden.
        /// </summary>
        [Fact]
        ...
        /// UserProfile-Ordner ausgehen und "Downloads" anhÃ¤ngen.
        /// </summary>
        [Fact]
        ...
        /// exakt "eBRestarterConfig.json" heiÃŸen.
        ///
        /// WAS WIRD GETESTET?
        /// Da RetrieveConfigFilePath intern RetrieveAppDataPath aufruft, mÃ¼ssen wir auch hier den
        /// LocalAppData-Pfad mocken. Danach prÃ¼fen wir die gesamte Kette.
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// Die Log-Datei muss zwingend im AppData-Verzeichnis liegen und "log.txt" heiÃŸen.
        /// </summary>
        [Fact]
