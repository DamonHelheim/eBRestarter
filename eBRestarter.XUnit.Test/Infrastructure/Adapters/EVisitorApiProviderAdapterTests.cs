...
{
    /// <summary>
    /// Testet den EVisitorApiProviderAdapter.
    ...
    /// </summary>
    public class EVisitorApiProviderAdapterTests
    {
        private readonly Mock<IRestClientPort> _mockRestClient;
        private readonly Mock<IEVisitorConfigPort> _mockConfigService;
        private readonly Mock<ILogger<EVisitorApiProviderAdapter>> _mockLogger;
        private readonly EVisitorApiProviderAdapter _sut;

        public EVisitorApiProviderAdapterTests()
        {
            _mockRestClient = new Mock<IRestClientPort>();
            _mockConfigService = new Mock<IEVisitorConfigPort>();
            _mockLogger = new Mock<ILogger<EVisitorApiProviderAdapter>>();

            var parser = new EVisitorApiResponseParser();

            _sut = new EVisitorApiProviderAdapter(
