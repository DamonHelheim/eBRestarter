...
namespace eBRestarter.XUnit.Test.Infrastructure.Services.Authentication
{
    ...
    /// </summary>
    public class WindowsCredentialValidationAdapterTests
    {
        /// <summary>
        ...
        {
            // ARRANGE
            var mockAdService = new Mock<IActiveDirectoryPort>();
            ...
            var useCase = new WindowsCredentialValidationAdapter(mockAdService.Object);
