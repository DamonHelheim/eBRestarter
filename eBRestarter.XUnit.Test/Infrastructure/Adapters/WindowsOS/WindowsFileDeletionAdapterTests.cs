...
namespace eBRestarter.Tests.Infrastructure.Handlers
{
    ...
    {
        private readonly WindowsFileDeletionAdapter _sut;
        private readonly string _baseTestDir;

        public WindowsFileDeletionServiceAdapterTests()
        {
            _sut = new WindowsFileDeletionAdapter(Microsoft.Extensions.Logging.Abstractions.NullLogger<WindowsFileDeletionAdapter>.Instance);
