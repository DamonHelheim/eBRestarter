...
namespace eBRestarter.XUnit.Test.Infrastructure.Browsers
{
    ...
    public class FirefoxBrowserTests
    {
        ...
        public void GetPaths_ShouldParseProfilesIni_AndGeneratePathsForRelativeAndAbsoluteProfiles()
        {
            ...
            // Wenn der FirefoxBrowserAdapter die Datei liest, geben wir ihm unser gefälschtes Array zurück
        ...
        /// Wir müssen sicherstellen, dass die FirefoxBrowserAdapter-Klasse diese komprimierte Datei korrekt sucht.
        ///
        /// WAS WIRD GETESTET?
