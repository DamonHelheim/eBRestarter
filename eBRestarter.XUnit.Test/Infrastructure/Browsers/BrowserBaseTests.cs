...
namespace eBRestarter.XUnit.Test.Infrastructure.Browsers
{
    ...
    public class BrowserBaseTests
    {
        ...
        private class TestDummyBrowser : BrowserBase
        {
            ...
            // Dummy-Werte für die abstrakten Properties. Diese Werte sind für die Tests größtenteils egal,
            ...
            // Ein Unit-Test darf "von außen" nicht auf protected Methoden zugreifen.
