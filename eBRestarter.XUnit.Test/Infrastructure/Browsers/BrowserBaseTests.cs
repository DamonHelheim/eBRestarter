...
{
    /// <summary>
    /// Testet die gemeinsame Logik aller Browser aus der abstrakten BrowserBaseAdapter.
    ...
    public class BrowserBaseTests
    {
        ...
        /// <summary>
        /// Da BrowserBaseAdapter abstrakt ist, kÃ¶nnen wir nicht einfach 'new BrowserBaseAdapter()' aufrufen.
        ...
        /// </summary>
        private class TestDummyBrowser : BrowserBaseAdapter
        {
            public TestDummyBrowser(IOperatingSystemFacade os, ILogger logger) : base(os, logger) { }

            // Dummy-Werte fÃ¼r die abstrakten Properties. Diese Werte sind fÃ¼r die Tests grÃ¶ÃƒÅ¸tenteils egal,
            ...
            // Ein Unit-Test darf "von auÃƒÅ¸en" nicht auf protected Methoden zugreifen.
