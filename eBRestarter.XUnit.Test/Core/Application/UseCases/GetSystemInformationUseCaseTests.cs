...
{
    /// <summary>
    /// Testet den GetSystemInformationUseCase.
    ...
    /// </summary>
    public class GetSystemInformationUseCaseTests
    {
        ...
        private readonly GetSystemInformationUseCase _sut;

        public GetSystemInformationUseCaseTests()
        {
            ...
            _sut = new GetSystemInformationUseCase(
