...
public sealed partial class UC_InformationCardUrls : UserControl
{
    /// <summary>
    ...
    /// <c>DataContext</c>. <see cref="ViewModelInfocenter"/> is registered as a singleton, so resolving it here
