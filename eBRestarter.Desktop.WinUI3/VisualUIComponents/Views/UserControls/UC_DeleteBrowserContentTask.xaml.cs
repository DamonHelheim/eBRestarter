...
public sealed partial class UC_DeleteBrowserContentTask : UserControl
{
    /// <summary>
    ...
    /// <c>DataContext</c>. <see cref="ViewModelRestartTask"/> is registered as a singleton, so resolving it here
    ...
    public UC_DeleteBrowserContentTask()
    {
