...
public class ManageRestarterCycleUseCase(
    IBrowserFactory browserFactory,
    ILocalizationService localizationService,
    IBrowserDisplayNameResolverUseCase browserDisplayNameResolver,
    ...
    IValidator<ManageRestarterCycleRequest> validator) : IManageRestarterCycleUseCase
{
    ...
    private readonly IBrowserDisplayNameResolverUseCase _browserDisplayNameResolver = browserDisplayNameResolver;
