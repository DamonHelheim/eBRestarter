...
namespace eBRestarter.Core.Application.UseCases.DownloadBrowser;
    ...
    IOsProcessControlOutboundPort processControlPort) : IDownloadBrowserUseCase
{
    ...
    private readonly IOsPathProvider _pathProvider = pathProvider ?? throw new ArgumentNullException(nameof(pathProvider));
