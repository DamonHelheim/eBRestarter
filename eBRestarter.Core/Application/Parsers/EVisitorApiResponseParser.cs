...
public sealed class EVisitorApiResponseParser : IEVisitorApiResponseParser
{
    public IpInfoData? ParseIpInfo(string jsonContent)
    {
    ...
    public double[] ParseHourlyEarnings(string jsonContent)
    {
    ...
    public double[] ParseDailyEarnings(string jsonContent, int daysInMonth)
    {
    ...
    public double[] ParseMonthlyEarnings(string jsonContent)
    {
