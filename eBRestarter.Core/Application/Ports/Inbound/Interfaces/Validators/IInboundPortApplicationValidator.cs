...
namespace eBRestarter.Core.Application.Ports.Inbound.Interfaces.Validators;
...
/// - <strong>Aufrufer (Consumer):</strong> Liegt INNERHALB des Application Cores (<see cref="Application.UseCases.DeleteBrowserContentUseCase"/>, <see cref="Application.Services.RestarterCycleService"/> etc.).<br/>
