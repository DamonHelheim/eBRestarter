...
/// - <strong>Aufrufer (Consumer):</strong> Liegt im Application Core (<see cref="Providers.SystemInformationProvider"/>).<br/>
...
/// - <em>Architektur-Hinweis:</em> Suffix <c>OutboundPort</c> ist vorbildlich. Trennt nach dem Interface Segregation Principle (ISP) sauber die Editions-Abfrage von der Hardware-Abfrage (<see cref="IOutboundPortHardwareInfoProvider"/>).
/// </para>
/// </summary>
public interface IOutboundPortOsEditionProvider
{
