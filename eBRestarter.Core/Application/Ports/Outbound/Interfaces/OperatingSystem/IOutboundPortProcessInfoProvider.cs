...
/// - <em>Architektur-Hinweis:</em> Suffix <c>OutboundPort</c> ist perfekt. Trennt nach ISP sauber die Prozess-Metadaten von Anwendungs-Verzeichnispfaden (<see cref="Outbound.Providers.IAppPathProviderOutboundPort"/>).
/// </para>
/// </summary>
public interface IOutboundPortProcessInfoProvider
{
