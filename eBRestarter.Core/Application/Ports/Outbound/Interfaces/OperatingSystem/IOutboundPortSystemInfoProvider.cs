...
/// - <strong>Aufrufer (Consumer):</strong> Liegt im Application Core (<see cref="BehavioralComponents.Providers.SystemInformationProvider"/>, <see cref="UseCases.ConfigureAutoLogonUseCase"/>) und in UI-ViewModels.<br/>
...
/// - <em>Architektur-Hinweis:</em> Suffix <c>OutboundPort</c> ist perfekt. Ergänzt sich nach dem Interface Segregation Principle (ISP) mit <see cref="IOutboundPortHardwareInfoProvider"/> und <see cref="IOutboundPortOsEditionProvider"/>.
/// </para>
/// </summary>
public interface IOutboundPortSystemInfoProvider
{
