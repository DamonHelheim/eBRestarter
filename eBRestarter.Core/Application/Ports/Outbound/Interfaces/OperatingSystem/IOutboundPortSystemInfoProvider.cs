...
/// - <strong>Aufrufer (Consumer):</strong> Liegt im Application Core (<see cref="Providers.SystemInformationProvider"/>, <see cref="UseCases.ConfigureAutoLogonUseCase"/>) und in UI-ViewModels.<br/>
