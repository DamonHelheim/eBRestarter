...
/// - <strong>Aufrufer (Consumer):</strong> Liegt im Application Core (Use Cases wie <see cref="eBRestarter.Core.Application.UseCases.ToggleAppAutoStartUseCase"/>, <see cref="eBRestarter.Core.Application.Services.RestarterCycleService"/>) sowie in GUI-ViewModels.<br/>
...
/// </para>
/// </summary>
public interface IEVisitorConfigRepositoryOutboundPort
{
    /// <summary>
