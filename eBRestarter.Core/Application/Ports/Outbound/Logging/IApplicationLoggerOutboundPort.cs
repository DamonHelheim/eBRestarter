namespace eBRestarter.Core.Application.Ports.Outbound.Logging;
...
/// - <strong>Aufrufer (Consumer):</strong> Liegt im Application Core (z. B. <see cref="eBRestarter.Core.Application.Services.ComputerRestartService"/>).<br/>
...
/// </para>
/// </summary>
public interface IApplicationLoggerOutboundPort<out TCategory>
{
