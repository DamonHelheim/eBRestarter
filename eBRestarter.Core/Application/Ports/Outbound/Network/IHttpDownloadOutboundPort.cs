...
/// - <strong>Aufrufer (Consumer):</strong> Liegt im Application Core (<see cref="eBRestarter.Core.Application.UseCases.DownloadBrowserUseCase"/>) sowie in GUI-ViewModels.<br/>
