...
/// - <strong>Aufrufer (Consumer):</strong> Liegt im Application Core (<see cref="eBRestarter.Core.Application.UseCases.ConfigureAutoLogonUseCase"/>) und in GUI-ViewModels.<br/>
