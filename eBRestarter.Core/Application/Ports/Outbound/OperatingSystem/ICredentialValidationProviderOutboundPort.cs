...
/// - <strong>Aufrufer (Consumer):</strong> Liegt im Application Core (<see cref="eBRestarter.Core.Application.UseCases.ConfigureAutoLogonUseCase"/>).<br/>
...
/// </para>
/// </summary>
public interface ICredentialValidationProviderOutboundPort
{
    /// <summary>
