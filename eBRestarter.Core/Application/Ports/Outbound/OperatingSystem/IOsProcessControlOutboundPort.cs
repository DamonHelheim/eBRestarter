...
/// - <strong>Aufrufer (Consumer):</strong> Liegt im Application Core (<see cref="eBRestarter.Core.Application.Services.ComputerRestartService"/>, Use Cases und Handlers) sowie in Browser-Adaptern und ViewModels.<br/>
...
/// </para>
/// </summary>
public interface IOsProcessControlOutboundPort
{
